...
//                        //int itemId = Integer.parseInt(words[ITEM_ID_INDEX]);
//                        //if(itemId>itemMaxNum) itemMaxNum=itemId;
//                        int userDuration = Integer.parseInt(words[USER_DURATION_INDEX]);
//                        int itemDuration = Integer.parseInt(words[ITEM_DURATION_INDEX]);
//                        if(itemDuration<=0) itemDuration=1;
//                        if(userDuration>itemDuration) userDuration=itemDuration;
//                        double score = 1+userDuration * 1.0 / itemDuration;//computeScore(userDuration,itemDuration);计算score
